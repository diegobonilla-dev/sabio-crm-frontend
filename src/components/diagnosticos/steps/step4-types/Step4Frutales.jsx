...
/**
 * Paso 4: Manejo de Cultivo - Frutales (Placeholder)
 *
 * Este componente es un placeholder básico que se desarrollará
 * con campos específicos para frutales en futuras iteraciones.
 */
export default function Step4Frutales({ data, onChange }) {
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex-1">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <p className="text-sm text-yellow-800 mb-2">
                <strong>⚠️ En desarrollo:</strong> Este formulario se adaptará según las necesidades específicas de frutales.
              </p>
              <p className="text-xs text-yellow-700">
                Los campos mostrados son temporales. Próximamente se incluirán:
                manejo fitosanitario, riego, podas, cosecha, y otras prácticas específicas de frutales.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Sección B: Lotes (placeholder simple) */}
          ...
          <div className="flex-1">
            ...
            <div className="bg-purple-100 border border-purple-300 rounded-lg p-4">
              <p className="text-sm text-purple-800">
                ...
                de lotes frutales, incluyendo: estado fenológico, producción esperada,
                incidencia de plagas y enfermedades, calidad del fruto, y análisis por lote.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
        <p className="text-xs text-slate-600 italic">
          ...
          que Step4Ganaderia.jsx una vez se definan los campos específicos para frutales.
        </p>
      </div>
    </div>
  );
