...
export default function Step2Aguacate({ data, finca, onChange }) {
  const { watch } = useForm({
    defaultValues: data?.datos_aguacate?.sistema_productivo || {}
  });
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold">Sistema Productivo - Aguacate</h2>
        <p className="text-gray-600">Información sobre lotes, variedades y producción de aguacate</p>
      </div>
