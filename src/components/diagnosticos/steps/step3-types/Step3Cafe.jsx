...
export default function Step3Cafe({ data, onChange }) {
  ...
  const {
    ...
    defaultValues: data?.datos_cafe?.fertilizacion_fumigacion || {
      general: {
  ...
  useEffect(() => {
    if (data?.datos_cafe?.fertilizacion_fumigacion) {
      reset(data.datos_cafe.fertilizacion_fumigacion);
    }
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h2 className="text-xl md:text-2xl font-bold">Fertilización y Fumigación - Café</h2>
