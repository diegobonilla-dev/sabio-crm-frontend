...
/**
 * Paso 3: Fertilización y Fumigación - Frutales
 *
 * Estructura:
...
export default function Step3Frutales({ data, onChange }) {
  ...
  const {
    ...
    defaultValues: data?.datos_frutales?.fertilizacion_fumigacion || {
      general: {
  ...
  useEffect(() => {
    if (data?.datos_frutales?.fertilizacion_fumigacion) {
      reset(data.datos_frutales.fertilizacion_fumigacion);
    }
